...
class Ujian extends CI_Controller {
	...
	public function index($tanggal_awal = null,$tanggal_akhir = null,$kelas = null,$tipe = null)
	{
		...
		$data["kelas"] = $kelas;
		$data["tipe"] = $tipe;
		$data["menu"] = 'Pembayaran UJIAN';
		$data["konfigurasi"] = $this->konfigurasi_model->config();
		$this->template->load('template', 'pembayaran/ujian_v', $data);
	}

	public function getspp($tanggal_awal,$tanggal_akhir,$kelas,$tipe)
	{
		$url = 'http://localhost/apiballet/ujian/view';
		$data = array(
			"username" => "SSM",
			"password" => "1234",
			"CMD1" => $tanggal_awal,
	...
	{
		$url = 'http://localhost/apiballet/master/getclassUjian';
		$data = array(
			"username" => "SSM",
			"password" => "1234",
		);     
