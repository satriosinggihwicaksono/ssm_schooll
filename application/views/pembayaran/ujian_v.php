                            ...
                            <table class="table" id="tandaitabelnya" style="text-align:center; width:100%;">
                                ...
                                <?php 
                                    if(!empty($data)){
                                        $x = 1;
                                        foreach($data['data'] as $d){
                                        $total = $d['price_exam'] - $d['amount_payment_remain'];
                                    ?>
                                    <tr class="border_bottom">
                                        ...
                                        <td><b><?=number_format($d['amount_payment_remain'], 0, ".", ".")?></b></td>
                                        <td><?=number_format($d['price_exam'], 0, ".", ".")?></td>
                                    </tr>
                                <?php
                                        }
                                    } 
...
function searchspp(){
    ...
    var kelas = $('.kelas').val();
    window.location="<?=base_url()?>Ujian/index/"+tanggal_awal+"/"+tanggal_akhir+"/"+kelas;    
}
</script>
